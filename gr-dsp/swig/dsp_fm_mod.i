...
***********************************************************************	
See Also:
	dsp_fm_mod.i  -> SWIG wrapper for C++ implementation
	dsp_fm_mod.h  -> Header for C++ implementation
***********************************************************************	
Notes:
	...
	The block doesn't implement a FIR filter but still contains a tap
	field which isn't used.  Any dummy taps can be passed.
***********************************************************************	
References:
***********************************************************************	
Examples:
	...
	dsp_init()
	dsp_fm_mod = dsp_fm_mod(taps, scale_data, interpolation, input_sig, output_sig, dsp_init, fir_id);
	
	connect(src, dsp_fm_mod, sink)
***********************************************************************	
*/
